    ...
    document.getElementById("submit").addEventListener("click", function() {
      ...
      if (document.getElementById("time").value == "") {
            Swal.fire({
              icon: 'error',
              title: 'Oops...',
              text: 'Tens de selecionar uma hora!',
            })
          }
          else {
          ...
          let arrival2 = new Date(arrival1).toISOString().slice(0, 10); setter = document.getElementById("time").value;
          let setter1 = arrival2 + " " + setter;
          let data = {
            arrival: setter1
          }
          fetch.putData(route1, data); window.location = "checkList.html";
        })
    })()
